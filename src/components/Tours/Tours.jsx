...
export const Tours = () => {
  ...
  return (
    <div id='tours' className='lg:w-[1487px] m-auto mt-[100px] scroll-mt-[90px] px-[20px]'>
        ...
        <ul className="flex flex-col gap-5 lg:flex-row items-center justify-between lg:w-full">
            <li className='rounded-xl lg:w-[347px] w-full'>
                <img className='w-full object-cover h-[192px] rounded-t-xl' src={toursImg1} alt="" />
            ...
            <li className='rounded-xl lg:w-[347px] w-full'>
                <img className='w-full object-cover h-[192px] rounded-t-xl' src={toursImg2} alt="" />
                <div className='flex flex-col items-start p-[24px] rounded-b-xl shadow-[0_0_7px_rgba(0,0,0,0.15)]'>
            ...
            <li className='rounded-xl lg:w-[347px] w-full'>
                <img className='w-full object-cover h-[192px] rounded-t-xl' src={toursImg3} alt="" />
                <div className='flex flex-col items-start p-[24px] rounded-b-xl shadow-[0_0_7px_rgba(0,0,0,0.15)]'>
            ...
            <li className='rounded-xl lg:w-[347px] w-full'>
                <img className='w-full object-cover h-[192px] rounded-t-xl' src={toursImg4} alt="" />
                <div className='flex flex-col items-start p-[24px] rounded-b-xl shadow-[0_0_7px_rgba(0,0,0,0.15)]'>
